...
class VescUart
{
	...
	//Timeout - specifies how long in us the function will wait for the vesc to respond
	const std::chrono::duration<int, std::milli> _TIMEOUT;
	...
	public:
       ...
       /** Variable to hold firmware version */
         ...
         */
        void setSerialPort(mbed::BufferedSerial* port);

        /**
         * @brief      Set debug printing on or off
         * @param      debug_enable use printf for debugging 
         */
        void setDebugEnable(bool debug_enable);
